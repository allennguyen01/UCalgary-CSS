...
function Resources() {
  return (
    <section className="grid grid-cols-4 grid-rows-3 gap-4 mx-8 mt-8 h-screen text-lg [&>*]:flex [&>*]:items-center [&>*]:justify-center [&>*]:text-center [&>*]:p-8">
      <ResourceBox title={"RESOURCES"} />
      <ResourceBox title={"Chinese Food"} />
      <ResourceBox title={"Other Chinese Communities in Calgary"} colSpan={2} />
      <ResourceBox
